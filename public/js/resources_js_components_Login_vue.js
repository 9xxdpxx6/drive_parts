...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "login-container position-absolute w-100 h-100" },
    [
      _c(
        "div",
        { staticClass: "position-absolute start-50 translate-middle-x w-25" },
        [
          _vm._m(0),
          _vm._v(" "),
          _c("div", { staticClass: "mb-3" }, [
            _c(
              "label",
              {
                staticClass: "form-label text-light ps-2",
                attrs: { for: "email" },
              },
              [_vm._v("Email")]
            ),
          ...
          _c("div", { staticClass: "d-flex" }, [
            _c("input", {
              staticClass: "btn btn-primary text-center w-50 mx-auto mt-3",
  ...
  function () {
    ...
    return _c("div", { staticClass: "login-title" }, [
      _c(
        ...
        {
          staticClass:
            "login-brand d-flex text-center flex-column text-secondary mt-",
        },
        [
          _c("img", {
            staticClass: "me-2",
            attrs: { src: "/assets/logo.svg", height: "160", alt: "Logo" },
          }),
          _vm._v(" "),
          _c("span", { staticClass: "fs-1 text-white mt-3" }, [
            _c("span", { staticStyle: { color: "#3751FF" } }, [
              _vm._v("DRIVE"),
            ]),
            _vm._v(" "),
            _c("span", { staticStyle: { color: "#6C757D" } }, [
              _vm._v("PARTS"),
            ]),
          ]),
        ]
