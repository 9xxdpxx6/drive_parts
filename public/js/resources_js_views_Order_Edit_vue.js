        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return axios.get("/api/orders/".concat(id));
            case 3:
              res = _context.sent;
              _this3.order = res.data.data;
              _this3.selectedCustomer = _this3.order.user;
              _this3.selectedCar = _this3.order.car;
              _this3.isPaid = _this3.order.is_paid;
              _this3.total = _this3.order.total;
              _this3.discount = _this3.order.discount;
              _this3.selectedStatus = _this3.order.status;
              _this3.selectedLabels = _this3.order.labels;
              if (_this3.order.is_paid) {
                _this3.selectedPaymentMethod = {
                  id: _this3.order.payment_method_id,
                  name: _this3.order.payment_method_name
                };
              }
              _this3.purchases = _this3.order.purchases;
              _this3.comment = _this3.order.comment;
              _this3.address = _this3.order.address;
              _this3.selectedDelivery = {
                id: _this3.order.delivery_id,
                name: _this3.order.delivery_name
              };
              _this3.deliveryPrice = _this3.order.delivery_price;
              _this3.note = _this3.order.note;
              _this3.orderDate = _store_Designer__WEBPACK_IMPORTED_MODULE_1__["default"].formatDateTime(_this3.order.date);
              _this3.updateTotals();
              _context.next = 23;
              return _this3.getCars();
            case 23:
              _context.next = 28;
              break;
            case 25:
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              res = _context4.sent;
              _this6.providers = res.data.data;
              _context4.next = 10;
              break;
            case 7:
              _context4.prev = 7;
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            ...
            case 5:
              res = _context7.sent;
              _this9.cars = res.data.data.filter(function (car) {
                return car.customer_id === _this9.selectedCustomer.id;
              });
              _context7.next = 12;
              break;
            case 9:
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            ...
            case 3:
              res = _context8.sent;
              _this10.paymentMethods = Object.entries(res.data).map(function (_ref) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            ...
            case 3:
              res = _context9.sent;
              _this11.deliveries = Object.entries(res.data).map(function (_ref3) {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              _context10.prev = 0;
              labelIds = null;
              if (_this12.selectedLabels) {
                labelIds = _this12.selectedLabels.map(function (label) {
                  return label.id;
                });
              }
              _this12.purchases.forEach(function (purchase) {
                return delete purchase.product;
              });
              data = {
                user_id: _this12.selectedCustomer.id,
                car_id: _this12.selectedCar ? _this12.selectedCar.id : null,
                is_paid: _this12.isPaid,
                total_price: _this12.total,
                discount: _this12.discount,
                status_id: _this12.selectedStatus.id,
                labels: labelIds,
                payment_method: _this12.selectedPaymentMethod ? _this12.selectedPaymentMethod.id : null,
                purchases: _this12.purchases,
                comment: _this12.comment,
                address: _this12.address,
                delivery: _this12.selectedDelivery.id,
                delivery_price: _this12.deliveryPrice,
                note: _this12.note
              };
              _this12.isDataLoaded = false;
              _context10.next = 8;
              return axios.patch("/api/orders/".concat(_this12.$route.params.id), data);
            case 8:
              _this12.isDataLoaded = true;
              _context10.next = 11;
              return _this12.$router.push({
                name: 'order.index'
              });
            case 11:
              _context10.next = 16;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Edit_vue_vue_type_template_id_6fc8ad2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Edit.vue?vue&type=template&id=6fc8ad2a&scoped=true& */ "./resources/js/views/Order/Edit.vue?vue&type=template&id=6fc8ad2a&scoped=true&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Edit_vue_vue_type_template_id_6fc8ad2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _Edit_vue_vue_type_template_id_6fc8ad2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "6fc8ad2a",
  null
...
/***/ "./resources/js/views/Order/Edit.vue?vue&type=template&id=6fc8ad2a&scoped=true&":
/*!**************************************************************************************!*\
  !*** ./resources/js/views/Order/Edit.vue?vue&type=template&id=6fc8ad2a&scoped=true& ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_6fc8ad2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_6fc8ad2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Edit_vue_vue_type_template_id_6fc8ad2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Edit.vue?vue&type=template&id=6fc8ad2a&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Order/Edit.vue?vue&type=template&id=6fc8ad2a&scoped=true&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Order/Edit.vue?vue&type=template&id=6fc8ad2a&scoped=true&":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Order/Edit.vue?vue&type=template&id=6fc8ad2a&scoped=true& ***!
  \*****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "d-flex flex-column flex-lg-row" }, [
      _c(
        "h3",
        { staticClass: "mt-2 mb-4 me-4 d-flex" },
        [
          _c("span", { staticClass: "me-3" }, [
            _vm._v("Редактирование заказа"),
          ]),
          _vm._v(" "),
          _vm.order
            ? _c(
                "router-link",
                {
                  staticClass: "text-decoration-none text-dark",
                  attrs: {
                    to: { name: "order.print", params: { id: _vm.order.id } },
                    target: "_blank",
                  },
                },
                [
                  _c("h3", { staticClass: "link-primary fs-2" }, [
    ...
    _c("div", { staticClass: "row" }, [
              ...
              _c("div", { staticClass: "subtotal text-end" }, [
                ...
                _c("div", [
                  ...
                  _vm.subTotal
                    ? _c("span", [
                        _vm._v(
                          _vm._s(_vm._f("formatNumber")(_vm.purchaseTotal))
                        ),
                      ])
                    : _vm._e(),
                  _vm._v(" "),
      ...
      _c("div", { staticClass: "user-info col-12 col-xxl-3 mt-5 mt-xxl-0" }, [
        ...
        _c("div", { staticClass: "order-date border-bottom pb-2 mb-3" }, [
          ...
          _vm._v(" "),
          _c("span", [_vm._v(_vm._s(_vm.orderDate))]),
        ]),
        _vm._v(" "),
        _c(
          "div",
          ...
          [
            ...
            _c(
              "v-select",
              {
                ...
                on: { input: _vm.handleUserChanged },
                scopedSlots: _vm._u([
                  {
                    key: "selected-option",
                    fn: function (option) {
