...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    this.getCategory(this.$route.params.alias);
    this.getCategories();
  },
  methods: {
    getCategory: function getCategory(alias) {
      var _this2 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var res, parentRes, file;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return axios.get("/api/categories/".concat(alias));
            case 3:
              res = _context.sent;
              _this2.category = res.data.data;
              _this2.name = _this2.category.name;
              _this2.alias = _this2.category.alias;
              _this2.isActive = _this2.category.is_active;
              _this2.parentId = _this2.category.parent_id;
              if (!_this2.parentId) {
                _context.next = 14;
                break;
              }
              _context.next = 12;
              return axios.get("/api/categories/".concat(_this2.parentId));
            case 12:
              parentRes = _context.sent;
              _this2.selectedCategory = parentRes.data.data;
            case 14:
              ...
              _context.next = 18;
              return _this2.dropzone.displayExistingFile(file, _this2.category.preview_image);
            case 18:
              _context.next = 23;
              break;
            case 20:
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 3:
              res = _context2.sent;
              _this3.categories = res.data.data.filter(function (category) {
                return category.id !== _this3.category.id;
              });
              _context2.next = 10;
              break;
            case 7:
    ...
    checkForm: function checkForm() {
      ...
      if (this.name.trim() === '') {
        ...
        this.categories.forEach(function (item) {
          if (_this4.name === item.name || _this4.alias === item.alias) {
            _this4.errors.name = "\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044F \"".concat(_this4.name, "\" \u0443\u0436\u0435 \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u0435\u0442");
          }
        });
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              data.append('category_id', _this5.category.id);
              data.append('is_active', _this5.isActive ? '1' : '0');
              if (_this5.imageForDelete) data.append('image_for_delete', _this5.imageForDelete);
              data.append('_method', 'PATCH');
              data.append('parent_id', _this5.selectedCategory ? _this5.selectedCategory.id : '');
              _this5.isDataLoaded = false;
              _context3.next = 14;
              return axios.post("/api/categories/".concat(_this5.category.alias), data);
            case 14:
...
var render = function () {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-12 col-md-4 col-xl-2 mb-4 mb-md-0" }, [
          ...
          _c("div", { staticClass: "d-flex justify-content-between" }, [
            ...
            _c("div", { staticClass: "form-check form-switch mb-3 d-flex" }, [
              _c(
                "label",
                {
                  staticClass: "form-check-label me-5 text-secondary",
