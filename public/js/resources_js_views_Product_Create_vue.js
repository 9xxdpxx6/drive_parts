      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _this4.errors.partNumber = '';
              _this4.errors.name = '';
              _this4.errors.price = '';
              _this4.errors.qty = '';
              _this4.errors.category = '';
              _this4.errors.brand = '';
              if (!(_this4.partNumber.trim() === '')) {
                _context4.next = 10;
                break;
              }
              _this4.errors.partNumber = 'Не указан артикул';
              _context4.next = 14;
              break;
            case 10:
              _context4.next = 12;
            ...
            case 12:
              _this4.products.forEach(function (item) {
                if (_this4.alias === item.alias) {
                  _this4.errors.name = "\u0422\u043E\u0432\u0430\u0440 \"".concat(_this4.name, "\" \u0443\u0436\u0435 \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u0435\u0442");
                }
              });
              if (!isNaN(_this4.name) || !isNaN(_this4.alias)) {
                _this4.errors.name = 'Наименование товара не может быть числом';
              }
            case 14:
              if (_this4.name.trim() === '') {
                _this4.errors.name = 'Не указано наименование товара';
              }
              if (_this4.price < 0) {
                _this4.errors.price = 'Цена должна быть меньше 0';
              }
              if (_this4.price === '' || _this4.price === null) {
                _this4.errors.price = 'Цена не указана';
              }
              if (_this4.qty < 0) {
                _this4.errors.qty = 'Количество должно быть меньше 0';
              }
              if (_this4.qty === '' || _this4.qty === null) {
                _this4.errors.qty = 'Количество не указано';
              }
              if (_this4.selectedCategory === null) {
                _this4.errors.category = 'Не указана категория';
              }
              if (_this4.selectedBrand === null) {
                _this4.errors.brand = 'Не указан производитель';
              }
              if (!(_this4.errors.partNumber || _this4.errors.name || _this4.errors.price || _this4.errors.qty || _this4.errors.category || _this4.errors.brand)) {
                _context4.next = 23;
                break;
              }
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              data = new FormData();
              files = _this5.dropzone.getAcceptedFiles();
              files.forEach(function (file) {
                data.append('images[]', file);
              });
              data.append('part_number', _this5.partNumber);
              data.append('name', _this5.name);
              data.append('alias', _this5.alias);
              data.append('description', _this5.description ? _this5.description : '');
              data.append('price', _this5.price);
              if (_this5.oldPrice) data.append('old_price', _this5.oldPrice);
              data.append('qty', _this5.qty);
              if (_this5.purchasePrice) data.append('purchase_price', _this5.purchasePrice);
              data.append('category_id', _this5.selectedCategory.id);
              data.append('brand_id', _this5.selectedBrand.id);
              data.append('is_active', _this5.isActive ? '1' : '0');
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Create_vue_vue_type_template_id_2be00b1b_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Create.vue?vue&type=template&id=2be00b1b&scoped=true& */ "./resources/js/views/Product/Create.vue?vue&type=template&id=2be00b1b&scoped=true&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Create_vue_vue_type_template_id_2be00b1b_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _Create_vue_vue_type_template_id_2be00b1b_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "2be00b1b",
  null
...
/***/ "./resources/js/views/Product/Create.vue?vue&type=template&id=2be00b1b&scoped=true&":
/*!******************************************************************************************!*\
  !*** ./resources/js/views/Product/Create.vue?vue&type=template&id=2be00b1b&scoped=true& ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Create_vue_vue_type_template_id_2be00b1b_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Create_vue_vue_type_template_id_2be00b1b_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Create_vue_vue_type_template_id_2be00b1b_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Create.vue?vue&type=template&id=2be00b1b&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/Create.vue?vue&type=template&id=2be00b1b&scoped=true&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/Create.vue?vue&type=template&id=2be00b1b&scoped=true&":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/Create.vue?vue&type=template&id=2be00b1b&scoped=true& ***!
  \*********************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _c("h3", { staticClass: "mt-2 mb-4" }, [_vm._v("Добавление товара")]),
    _vm._v(" "),
