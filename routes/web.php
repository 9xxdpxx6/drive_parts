...
//    Route::delete('/{group}', \App\Http\Controllers\Group\DestroyController::class)->name('group.delete');
//});
//
...
//    Route::delete('/{tag}', \App\Http\Controllers\Tag\DestroyController::class)->name('tag.delete');
//});
//
//Route::group(['prefix' => 'colors'], function () {
//    Route::get('/', \App\Http\Controllers\Label\IndexController::class)->name('color.index');
//    Route::get('/create', \App\Http\Controllers\Label\CreateController::class)->name('color.create');
//    Route::post('/', \App\Http\Controllers\Label\StoreController::class)->name('color.store');
//    Route::get('/{color}/edit', \App\Http\Controllers\Label\EditController::class)->name('color.edit');
//    Route::get('/{color}', \App\Http\Controllers\Label\ShowController::class)->name('color.show');
//    Route::patch('/{color}', \App\Http\Controllers\Label\UpdateController::class)->name('color.update');
//    Route::delete('/{color}', \App\Http\Controllers\Label\DestroyController::class)->name('color.delete');
//});
//
