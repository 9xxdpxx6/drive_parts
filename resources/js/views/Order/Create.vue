<template>
    <div>
        ...
        <div class="d-flex flex-column flex-lg-row">
            <h3 class="mt-2 mb-4 me-4">Добавление заказа</h3>
                ...
                <div class="order-content mb-5">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                        ...
                        <div class="subtotal text-end">
                            <div>
                                <span>Сумма:</span>
                                <span>{{ subTotal | formatNumber }}</span>
                                <span>руб</span>
                            </div>
                            <div>
                                <span>Сумма З/Ц:</span>
                                <span>{{ purchaseTotal | formatNumber }}</span>
                                <span>руб</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="order-params">
                    ...
                    <div class="mb-3 d-flex justify-content-between px-1">
                        ...
                        <div class="total text-end h5">
                            ...
                            <span class="me-2">{{ total |formatNumber }}</span>
                            <span>руб</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="user-info col-12 col-xxl-3 mt-5 mt-xxl-0">
                ...
                <div class="customer mb-3 v-select-container">
                    ...
                    <v-select v-model="selectedCustomer" :options="customers" value="id"
                              ...
                              id="inputCustomer" @input="handleUserChanged" @search="getCustomers">
...
export default {
    ...
    computed: {
        ...
        currentDateTime() {
            return Designer.formatDateTime(new Date())
        }
    }
}
</script>
