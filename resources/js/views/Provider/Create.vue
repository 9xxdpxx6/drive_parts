<template>
    <div>
        <a @click.prevent="$router.back()" class="col-12 col-md-4 col-lg-3 col-xl-2 link-primary text-decoration-none fw-bold d-flex align-items-center"
           role="button">
            <i class="bi bi-arrow-left-short fs-4"></i>
            <span>Вернуться к списку</span>
        </a>
        <h3 class="mt-2 mb-4">Добавление поставщика</h3>
        <div class="row">
            ...
            if (this.name.trim() === '') {
                ...
                this.providers.forEach(item => {
                    ...
                    if (this.code === item.code) {
                        this.errors.code = `Поставщик с кодом "${this.code}" уже существует`
                    }
                })
                if (!isNaN(this.name)) {
